...
describe('application', () => {
  ...
  describe('generate', () => {
    it('should work', () => {
      ...
      runSchematic('@khulnasoft/bazel:app --name=myApp');
    ...
    it('should work with multiple applications', () => {
      runSchematic('@khulnasoft/bazel:application --name=proj');
      runSchematic('@khulnasoft/bazel:app --name=first');
      runSchematic('@khulnasoft/bazel:app --name=second');
