...
describe('Next.js Styles', () => {
  ...
  it('should support different --style options', async () => {
    ...
    runCLI(
      `generate @titan/next:app ${lessApp} --no-interactive --style=less --appDir=false --src=false`
    );
    ...
    runCLI(
      `generate @titan/next:app ${scApp} --no-interactive --style=styled-components --appDir=false`
    );
    ...
    runCLI(
      `generate @titan/next:app ${scAppWithAppRouter} --no-interactive --style=styled-components --appDir=true`
    );
    ...
    runCLI(
      `generate @titan/next:app ${emotionApp} --no-interactive --style=@emotion/styled --appDir=false`
    );
