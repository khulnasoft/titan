...
describe('application', () => {
  ...
  it('creates a new application in a workspace', () => {
    runSchematic('@khulnasoft/titan:application --name=proj');
    runSchematic('@khulnasoft/titan:app --name=myApp', {projectName: 'proj'});
  ...
  it('creates multiple applications in a workspace', () => {
    runSchematic('@khulnasoft/titan:application --name=proj2');
    runSchematic('@khulnasoft/titan:app --name=first', {projectName: 'proj2'});
    runSchematic('@khulnasoft/titan:app --name=second', {projectName: 'proj2'});
