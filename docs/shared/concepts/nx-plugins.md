...
- [Set up a tool](/features/generate-code) for the first time. With the [`@titan/playwright`](/nx-api/playwright) plugin installed, you can use the `@titan/playwright:configuration` code generator to set up Playwright tests in an existing project.
