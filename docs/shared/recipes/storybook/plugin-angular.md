...
You can generate Storybook configuration for an individual Angular project by using the [`@titan/angular:storybook-configuration` generator](/nx-api/angular/generators/storybook-configuration), like this:

```shell
nx g @titan/angular:storybook-configuration project-name
```

## Auto-generate Stories

The [`@titan/angular:storybook-configuration` generator](/nx-api/angular/generators/storybook-configuration) has the option to automatically generate `*.stories.ts` files for each component declared in the library. The stories will be generated using [Component Story Format 3 (CSF3)](https://storybook.js.org/blog/storybook-csf3-is-here/).
...
If you add more components to your project, and want to generate stories for all your (new) components at any point, you can use the [`@titan/angular:stories` generator](/nx-api/angular/generators/stories):

```shell
nx g @titan/angular:stories --project=<project-name>
```
...
```shell
nx g @titan/angular:stories --project=feature-ui
```
...
The [`@titan/angular:storybook-configuration` generator](/nx-api/angular/generators/storybook-configuration) would generate a Story file that looks like this:
