...
The `@titan/angular:storybook-migrate-defaults-5-to-6` generator will not exactly do a migration. It will perform the following actions:
...
```shell
nx g @titan/angular:storybook-migrate-defaults-5-to-6
```
