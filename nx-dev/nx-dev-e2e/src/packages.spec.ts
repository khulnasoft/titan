...
const pages: Array<{ title: string; path: string }> = [
  { title: '@titan/angular', path: '/packages/angular' },
  {
    title: '@titan/angular:add-linting',
    path: '/packages/angular/generators/add-linting',
  },
  {
    title: '@titan/angular:application',
    path: '/packages/angular/generators/application',
  },
  {
    title: '@titan/angular:component',
    path: '/packages/angular/generators/component',
  },
  {
    title: '@titan/angular:component-cypress-spec',
    path: '/packages/angular/generators/component-cypress-spec',
  },
  {
    title: '@titan/angular:component-story',
    path: '/packages/angular/generators/component-story',
  },
  { title: '@titan/angular:init', path: '/packages/angular/generators/init' },
  {
    title: '@titan/angular:library',
    path: '/packages/angular/generators/library',
  },
  {
    title: '@titan/angular:library-secondary-entry-point',
    path: '/packages/angular/generators/library-secondary-entry-point',
  },
  {
    title: '@titan/angular:remote',
    path: '/packages/angular/generators/remote',
  },
  { title: '@titan/angular:move', path: '/packages/angular/generators/move' },
  {
    title: '@titan/angular:convert-to-with-mf',
    path: '/packages/angular/generators/convert-to-with-mf',
  },
  { title: '@titan/angular:host', path: '/packages/angular/generators/host' },
  {
    title: '@titan/angular:ng-add',
    path: '/packages/angular/generators/ng-add',
  },
  { title: '@titan/angular:ngrx', path: '/packages/angular/generators/ngrx' },
  { title: '@titan/angular:scam', path: '/packages/angular/generators/scam' },
  {
    title: '@titan/angular:scam-directive',
    path: '/packages/angular/generators/scam-directive',
  },
  {
    title: '@titan/angular:scam-pipe',
    path: '/packages/angular/generators/scam-pipe',
  },
  {
    title: '@titan/angular:setup-mf',
    path: '/packages/angular/generators/setup-mf',
  },
  {
    title: '@titan/angular:setup-tailwind',
    path: '/packages/angular/generators/setup-tailwind',
  },
  {
    title: '@titan/angular:stories',
  ...
  { title: '@titan/cypress', path: '/packages/cypress' },
  { title: '@titan/cypress:init', path: '/packages/cypress/generators/init' },
  {
    title: '@titan/cypress:cypress-project',
    path: '/packages/cypress/generators/cypress-project',
  },
  {
    title: '@titan/cypress:cypress',
  ...
  { title: '@titan/devkit', path: '/packages/devkit' },
  { title: '@titan/esbuild', path: '/packages/esbuild' },
  {
    title: '@titan/esbuild:esbuild',
    path: '/packages/esbuild/executors/esbuild',
  },
  { title: '@titan/eslint-plugin', path: '/packages/eslint-plugin' },
  ...
  { title: '@titan/jest', path: '/packages/jest' },
  { title: '@titan/jest:init', path: '/packages/jest/generators/init' },
  {
    title: '@titan/jest:configuration',
    path: '/packages/jest/generators/configuration',
  },
  { title: '@titan/jest', path: '/packages/jest/executors/jest' },
  ...
  { title: '@titan/eslint', path: '/packages/eslint' },
  {
    title: '@titan/eslint:workspace-rules-project',
  ...
  { title: '@titan/eslint', path: '/packages/eslint/executors/lint' },
  ...
  { title: '@titan/next', path: '/packages/next' },
  { title: '@titan/next:init', path: '/packages/next/generators/init' },
  {
    title: '@titan/next:application',
    path: '/packages/next/generators/application',
  },
  { title: '@titan/next:page', path: '/packages/next/generators/page' },
  {
    title: '@titan/next:component',
    path: '/packages/next/generators/component',
  },
  { title: '@titan/next:library', path: '/packages/next/generators/library' },
  { title: '@titan/next:build', path: '/packages/next/executors/build' },
  { title: '@titan/next:server', path: '/packages/next/executors/server' },
  { title: '@titan/next:export', path: '/packages/next/executors/export' },
