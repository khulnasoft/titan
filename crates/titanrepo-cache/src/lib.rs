...
pub enum CacheError {
    ...
    ApiClientError(Box<titanrepo_api_client::Error>, #[backtrace] Backtrace),
    ...
    PathError(#[from] titanpath::PathError, #[backtrace] Backtrace),
...
impl From<titanrepo_api_client::Error> for CacheError {
    fn from(value: titanrepo_api_client::Error) -> Self {
