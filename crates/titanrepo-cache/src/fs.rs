...
use titanrepo_api_client::{analytics, analytics::AnalyticsEvent};
...
impl FSCache {
    fn resolve_cache_dir(
        ...
        if let Some(override_dir) = override_dir {
            ...
            repo_root.join_components(&["node_modules", ".cache", "titan"])
        }
    }
...
mod test {
    ...
    use titanpath::AnchoredSystemPath;
    use titanrepo_analytics::start_analytics;
