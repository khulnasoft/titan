...
use titan_tasks::{small_duration::SmallDuration, StatsType};
...
impl TaskStats {
    ...
    pub fn new(stats_type: StatsType) -> Self {
        match stats_type {
            titan_tasks::StatsType::Essential => Self::Essential(TaskStatsEssential::default()),
            titan_tasks::StatsType::Full => Self::Full(Box::default()),
        }
    }
