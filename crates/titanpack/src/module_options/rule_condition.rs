...
use titan_tasks::{primitives::Regex, trace::TraceRawVcs, ReadRef, Vc};
...
pub enum ModuleRuleCondition {
    ...
    ResourcePathRegex(#[titan_tasks(trace_ignore)] Regex),
    ...
    ResourceBasePathGlob(#[titan_tasks(trace_ignore)] ReadRef<Glob>),
}
