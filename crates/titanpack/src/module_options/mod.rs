...
use titanpack_ecmascript::{EcmascriptInputTransform, EcmascriptOptions, SpecifiedModuleType};
use titanpack_mdx::MdxTransformOptions;
use titanpack_node::transforms::{postcss::PostCssTransform, webpack::WebpackLoaders};
...
async fn package_import_map_from_import_mapping(
    ...
    import_map.insert_exact_alias(
        format!("@khulnasoft/titanpack/{}", package_name),
        package_mapping,
    );
    Ok(import_map.cell())
}
