...
use titan_tasks::{trace::TraceRawVcs, Vc};
use titan_tasks_fs::FileSystemPath;
use titanpack_core::{
    reference_type::ReferenceType, source::Source, source_transform::SourceTransforms,
};
use titanpack_css::CssModuleAssetType;
use titanpack_ecmascript::{EcmascriptInputTransforms, EcmascriptOptions};
use titanpack_mdx::MdxTransformOptions;
use titanpack_wasm::source::WebAssemblySourceType;
...
#[titan_tasks::value(serialization = "auto_for_input", shared)]
...
pub enum ModuleType {
    ...
    // its source transform. Refer `titanpack-mdx::into_ecmascript_module_asset` for the reason
