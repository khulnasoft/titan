...
use titanpack_json::JsonModuleAsset;
...
pub fn register() {
    ...
    titanpack_css::register();
    titanpack_ecmascript::register();
    titanpack_node::register();
    titanpack_env::register();
    titanpack_mdx::register();
    titanpack_json::register();
    titanpack_static::register();
    titanpack_wasm::register();
