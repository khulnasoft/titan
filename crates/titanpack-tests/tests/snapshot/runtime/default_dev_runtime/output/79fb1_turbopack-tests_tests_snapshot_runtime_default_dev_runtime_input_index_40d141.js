(globalThis.TITANPACK = globalThis.TITANPACK || []).push([
  ...
  {
    otherChunks: [
      "output/79fb1_titanpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_7e4b32.js",
    ],
    runtimeModuleIds: [
      "[project]/crates/titanpack-tests/tests/snapshot/runtime/default_dev_runtime/input/index.js [test] (ecmascript)",
    ],
  },
]);
(() => {
  ...
  const OUTPUT_ROOT =
    "crates/titanpack-tests/tests/snapshot/runtime/default_dev_runtime";
  /**
