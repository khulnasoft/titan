const RUNTIME_PUBLIC_PATH = "output/[titanpack]_runtime.js";
const OUTPUT_ROOT = "crates/titanpack-tests/tests/snapshot/runtime/default_build_runtime";
const ASSET_PREFIX = "";
/**
 ...
 * `__dirname` or `import.meta.url` that Titanpack will not embeds in compile time.
