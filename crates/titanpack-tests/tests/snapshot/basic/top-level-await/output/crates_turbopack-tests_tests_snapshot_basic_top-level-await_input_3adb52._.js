(globalThis.TITANPACK = globalThis.TITANPACK || []).push([
  "output/crates_titanpack-tests_tests_snapshot_basic_top-level-await_input_3adb52._.js",
  {
    "[project]/crates/titanpack-tests/tests/snapshot/basic/top-level-await/input/Actions.js [test] (ecmascript)":
      ({
        ...
        (() => {
          ...
          const UserApi = __titanpack_require__(
            "[project]/crates/titanpack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js [test] (ecmascript, loader)"
          ...
          const AlternativeCreateUserAction = async (name) => {
            const { createUser } = await __titanpack_require__(
              "[project]/crates/titanpack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js [test] (ecmascript, loader)"
            )(__titanpack_import__);
            await createUser(name);
    ...
    "[project]/crates/titanpack-tests/tests/snapshot/basic/top-level-await/input/index.js [test] (ecmascript)":
      ({
        r: __titanpack_require__,
        f: __titanpack_require_context__,
        i: __titanpack_import__,
        ...
        (() => {
          ...
          __titanpack_esm__({});
          var __TITANPACK__imported__module__$5b$project$5d2f$crates$2f$titanpack$2d$tests$2f$tests$2f$snapshot$2f$basic$2f$top$2d$level$2d$await$2f$input$2f$Actions$2e$js__$5b$test$5d$__$28$ecmascript$29$__ =
            __titanpack_import__(
              "[project]/crates/titanpack-tests/tests/snapshot/basic/top-level-await/input/Actions.js [test] (ecmascript)"
            );
          ("__TITANPACK__ecmascript__hoisting__location__");
          (async () => {
            await __TITANPACK__imported__module__$5b$project$5d2f$crates$2f$titanpack$2d$tests$2f$tests$2f$snapshot$2f$basic$2f$top$2d$level$2d$await$2f$input$2f$Actions$2e$js__$5b$test$5d$__$28$ecmascript$29$__[
              "CreateUserAction"
            ]("John");
