...
use titan_tasks::{RawVc, ReadRef, TransientInstance, TransientValue, TryJoinIterExt, Vc};
use titan_tasks_fs::{source_context::get_source_context, FileLinesContent};
use titanpack_core::issue::{
...
#[titan_tasks::value(shared, serialization = "none", eq = "manual")]
#[derive(Clone)]
