//! Testing utilities and macros for titan-tasks and applications based on it.
...
impl TitanTasksCallApi for VcStorage {
    fn dynamic_call(
        &self,
        func: titan_tasks::FunctionId,
        inputs: Vec<titan_tasks::ConcreteTaskInput>,
    ) -> RawVc {
        ...
        handle.spawn(with_titan_tasks_for_testing(this.clone(), id, async move {
    ...
    fn native_call(
        &self,
        _func: titan_tasks::FunctionId,
        _inputs: Vec<titan_tasks::ConcreteTaskInput>,
    ) -> RawVc {
        unreachable!()
    }
    ...
    fn trait_call(
        &self,
        _trait_type: titan_tasks::TraitTypeId,
...
impl TitanTasksApi for VcStorage {
    ...
    fn invalidate_with_reason(
        &self,
        _task: TaskId,
        _reason: titan_tasks::util::StaticOrArc<dyn titan_tasks::InvalidationReason>,
    ) {
        unreachable!()
    }
    ...
    fn emit_collectible(&self, _trait_type: titan_tasks::TraitTypeId, _collectible: RawVc) {
        unimplemented!()
    }
