declare const __titanpack_external_require__: (id: string) => any;

// @ts-ignore
import postcss from "@khulnasoft/titanpack/postcss";
// @ts-ignore
  ...
  const loadedPlugins = plugins.map((plugin) => {
    if (Array.isArray(plugin)) {
      ...
      if (typeof pluginFactory === "string") {
        pluginFactory = __titanpack_external_require__(pluginFactory);
      }
