...
#[derive(Clone, Debug)]
pub struct JavaScriptEvaluation(#[titan_tasks(trace_ignore)] JavaScriptStream);
...
pub fn evaluate(
    ...
    let cell = titan_tasks::macro_helpers::find_cell_by_type(*JAVASCRIPTEVALUATION_VALUE_TYPE_ID);
