...
interface TitanpackDevBaseContext extends TitanpackBaseContext {
  k: RefreshContext;
}

interface TitanpackDevContext extends TitanpackDevBaseContext {}
