...
use titanrepo_auth::{
    TITANREPO_AUTH_FILE_NAME, TITANREPO_CONFIG_DIR, TITANREPO_LEGACY_AUTH_FILE_NAME,
};
use titanrepo_dirs::config_dir;
use titanrepo_ui::UI;

use crate::{
    config::{ConfigurationOptions, Error as ConfigError, TitanrepoConfigBuilder},
    Args,
};
...
impl CommandBase {
    ...
    fn config_init(&self) -> Result<ConfigurationOptions, ConfigError> {
        TitanrepoConfigBuilder::new(self)
    ...
    fn global_config_path(&self) -> Result<AbsoluteSystemPathBuf, ConfigError> {
        ...
        let global_config_path = config_dir
            .join(TITANREPO_CONFIG_DIR)
            .join(TITANREPO_LEGACY_AUTH_FILE_NAME);
    ...
    /// Current working directory for the titan command
...
mod test {
    ...
    #[test_case("/tmp/titanrepo", "6e0cfa616f75a61c"; "basic example")]
    ...
    #[test_case("C:\\\\tmp\\titanrepo", "0103736e6883e35f"; "basic example")]
