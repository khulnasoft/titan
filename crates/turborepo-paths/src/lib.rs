...
//! Titanrepo's path handling library.
//! Defines distinct path types for the different uses of paths in Titanrepo's
//! codebase.
//!
...
//! recommended is inside titanpath itself. But that unchecked initialization
