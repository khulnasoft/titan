...
use titanpack_dev::react_refresh::assert_can_resolve_react_refresh;
...
pub async fn get_client_import_map(project_path: Vc<FileSystemPath>) -> Result<Vc<ImportMap>> {
    ...
    import_map.insert_wildcard_alias(
        "@khulnasoft/titanpack-ecmascript-runtime/",
        ImportMapping::PrimaryAlternative(
            "./*".to_string(),
            Some(titanpack_ecmascript_runtime::embed_fs().root()),
        )
        .cell(),
    );
