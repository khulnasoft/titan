...
/* @titanpack-bench:eval-start */
/* @titanpack-bench:eval-end */
"#};
const USE_EFFECT: &str = indoc! {r#"
React.useEffect(() => {
    if (EFFECT_PROPS.hydration) {
        globalThis.__titanpackBenchBinding && globalThis.__titanpackBenchBinding("Hydration done");
    }
    if (EFFECT_PROPS.message) {
        globalThis.__titanpackBenchBinding && globalThis.__titanpackBenchBinding(EFFECT_PROPS.message);
    }
}, [EFFECT_PROPS]);
"#};
                ...
                return (
                    <html lang="en">
                        <head>
                            ...
                            <title>Titanpack Test App</title>
                        </head>
                        <body>
                            {children}
                        </body>
