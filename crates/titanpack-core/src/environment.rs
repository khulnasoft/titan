...
#[derive(Default)]
pub struct ServerAddr(#[titan_tasks(trace_ignore)] Option<SocketAddr>);
...
/// A simple serializable structure meant to carry information about Titanpack's
...
pub struct RuntimeVersions(#[titan_tasks(trace_ignore)] pub Versions);
