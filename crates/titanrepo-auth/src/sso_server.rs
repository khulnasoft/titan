...
fn get_token_and_redirect(payload: SsoPayload) -> Result<(Option<String>, Url), Error> {
    let location_stub = "https://vercel.com/notifications/cli-login/titan/";
...
mod tests {
    ...
    fn test_get_token_and_redirect() {
        assert_eq!(
            ...
            (
                None,
                Url::parse("https://vercel.com/notifications/cli-login/titan/success").unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse(
                    "https://vercel.com/notifications/cli-login/titan/failed?loginError=error"
                )
                .unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse(
                    "https://vercel.com/notifications/cli-login/titan/incomplete?ssoEmail=email"
                )
                .unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse("https://vercel.com/notifications/cli-login/titan/incomplete?ssoEmail=email&teamName=team")
                    .unwrap()
            )
        );
