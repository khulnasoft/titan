...
pub use server::{CloseReason, FileWatching, TitanGrpcService};

pub(crate) mod proto {

    tonic::include_proto!("titandprotocol");
    ...
    impl From<PackageManager> for titanrepo_repository::package_manager::PackageManager {
    ...
    impl From<titanrepo_repository::package_manager::PackageManager> for PackageManager {
        fn from(pm: titanrepo_repository::package_manager::PackageManager) -> Self {
            match pm {
                titanrepo_repository::package_manager::PackageManager::Npm => Self::Npm,
                titanrepo_repository::package_manager::PackageManager::Yarn => Self::Yarn,
                titanrepo_repository::package_manager::PackageManager::Berry => Self::Berry,
                titanrepo_repository::package_manager::PackageManager::Pnpm => Self::Pnpm,
                titanrepo_repository::package_manager::PackageManager::Pnpm6 => Self::Pnpm6,
                titanrepo_repository::package_manager::PackageManager::Bun => Self::Bun,
            }
        }
    }
}
