...
mod test {
    ...
    fn test_resolve_package() -> Result<(), Error> {
        ...
        let tests = [
            ("", "titan", "node_modules/titan", "1.5.5"),
            (
                "apps/web",
                "lodash",
    ...
    fn test_all_dependencies() -> Result<(), Error> {
        ...
        let tests = [
            ...
            (
                "node_modules/titan",
                vec![
                    "node_modules/titan-darwin-64",
                    "node_modules/titan-darwin-arm64",
                    "node_modules/titan-linux-64",
                    "node_modules/titan-linux-arm64",
                    "node_modules/titan-windows-64",
                    "node_modules/titan-windows-arm64",
                ],
            ),
            (
    ...
    fn test_workspace_peer_dependencies() -> Result<(), Error> {
        ...
        let closures = crate::all_transitive_closures(
            ...
            vec![
                (
                    "packages/a".into(),
                    vec![("eslint-plugin-titan".into(), "^1.9.3".into())]
                        .into_iter()
                        .collect(),
                ),
        ...
        assert!(closures.get("packages/a").unwrap().contains(&Package {
            key: "node_modules/eslint-plugin-titan".into(),
            version: "1.9.3".into()
        }));
