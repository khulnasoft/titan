...
use nom::Finish;
use titanpath::{AbsoluteSystemPathBuf, RelativeUnixPathBuf};
...
mod tests {
    ...
    use titanpath::RelativeUnixPathBuf;
        ...
        let tests: &[(&str, &[(&str, &str)])] = &[
            ...
            (
                ...
                "100644 blob e69de29bb2d1d6434b8b29ae775ad8c2e48c5391\t\t\000100644 blob \
                 ...
                 33d0621ee2f4da4a2f6f6bdd51a42618d181e337\ttitan.json\000100644 blob \
                ...
                &[
                    ...
                    ("titan.json", "33d0621ee2f4da4a2f6f6bdd51a42618d181e337"),
                    (
                        "file with spaces",
