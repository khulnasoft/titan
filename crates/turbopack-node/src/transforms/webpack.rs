...
use serde_json::json;
use titan_tasks::{trace::TraceRawVcs, Completion, Value, Vc};
use titan_tasks_bytes::stream::SingleValue;
use titan_tasks_fs::{json::parse_json_with_source_context, File, FileContent};
use titanpack_core::{
...
#[titan_tasks::value(transparent, serialization = "custom")]
...
#[derive(Debug, Clone)]
#[titan_tasks::value(shared, transparent)]
