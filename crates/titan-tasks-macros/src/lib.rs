...
/// ## Arguments
///
/// Example: `#[titan_tasks::value(into = "new", eq = "manual")]`
///
/// ### `cell`
///
/// Possible values:
...
/// No value.
///
/// Example: `#[titan_tasks::value(shared)]`
///
/// ### `transparent`
///
...
/// No value.
///
/// Example: `#[titan_tasks::value(transparent)]`
///
...
///
/// ```
/// use crate::generic_type as __titan_tasks_internal_generic_type;
///
/// __titan_tasks_internal_generic_type!(<A, B>, GenericType<Vc<A>, Vc<B>>);
///
