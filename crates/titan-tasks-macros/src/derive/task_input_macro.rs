...
use titan_tasks_macros_shared::{expand_fields, generate_exhaustive_destructuring};
...
pub fn derive_task_input(input: TokenStream) -> TokenStream {
    ...
    let (try_from_impl, from_impl) = match &derive_input.data {
        Data::Enum(DataEnum { variants, .. }) => {
            ...
            (
                quote! {
                    match value {
                        titan_tasks::ConcreteTaskInput::List(value) => {
                            ...
                            let discriminant: #repr = titan_tasks::TaskInput::try_from_concrete(discriminant)?;
                    ...
                    match self {
                        #(
                            #ident::#variants_idents #variants_fields_destructuring => {
                                ...
                                titan_tasks::ConcreteTaskInput::List(#inputs_list_ident)
                            }
                        )*
                    }
                },
    ...
    quote! {
        impl #generics titan_tasks::TaskInput for #ident #generics
        where
            #(#generic_params: titan_tasks::TaskInput,)*
        {
            #[allow(non_snake_case)]
            #[allow(unreachable_code)] // This can occur for enums with no variants.
            fn try_from_concrete(value: &titan_tasks::ConcreteTaskInput) -> titan_tasks::Result<Self> {
                #try_from_impl
            }

            #[allow(non_snake_case)]
            #[allow(unreachable_code)] // This can occur for enums with no variants.
            fn into_concrete(self) -> titan_tasks::ConcreteTaskInput {
                #from_impl
            }
        }
    }
    ...
    (
        ...
        quote! {
            #(
                ...
                let #fields_idents = titan_tasks::TaskInput::try_from_concrete(#fields_idents)?;
            )*
        },
        quote! {
            #(
