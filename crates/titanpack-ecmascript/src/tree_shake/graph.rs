                ...
                .neighbors_directed(ix as u32, petgraph::Direction::Outgoing)
            {
                ...
                chunk
                    ...
                    .push(ModuleItem::ModuleDecl(ModuleDecl::Import(ImportDecl {
                        ...
                        type_only: false,
                        with: Some(Box::new(create_titanpack_chunk_id_assert(dep))),
                    })));
            }
                    ...
                    if required_vars.remove(var) {
                        let assertion_prop =
                            PropOrSpread::Prop(Box::new(Prop::KeyValue(KeyValueProp {
                                key: quote_ident!("__titanpack_var__").into(),
...
const ASSERT_CHUNK_KEY: &str = "__titanpack_chunk__";

fn create_titanpack_chunk_id_assert(dep: u32) -> ObjectLit {
    ObjectLit {
        span: DUMMY_SP,
...
pub(crate) fn find_titanpack_chunk_id_in_asserts(asserts: &ObjectLit) -> Option<u32> {
