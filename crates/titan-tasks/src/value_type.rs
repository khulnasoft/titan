...
// titan-task In this case a trait_method might be of a different function type.
...
impl ValueType {
    /// This is internally used by `#[titan_tasks::value]`
    pub fn new<T>() -> Self {
        Self {
    ...
    /// This is internally used by `#[titan_tasks::value_impl]`
