    ...
    T: VcValueType,
{
    ...
    /// `Completion`. When using `#[titan_tasks::value(transparent)]`, the
...
/// Representation for standard `#[titan_tasks::value]`, where a read return a
...
/// Representation for `#[titan_tasks::value(transparent)]` types, where reads
    ...
    Repr: VcValueType,
{
    ...
    fn value_to_target_ref(value: &T) -> &Self::Target {
        ...
        // `#[titan_tasks::value(transparent)]` macro.
