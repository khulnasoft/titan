...
use crate::{
    ...
    util::SharedError,
    ConcreteTaskInput, {self as titan_tasks},
};

/// A native (rust) titan-tasks function. It's used internally by
/// `#[titan_tasks::function]`.
#[titan_tasks::value(cell = "new", serialization = "none", eq = "manual")]
