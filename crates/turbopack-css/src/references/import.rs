...
#[titan_tasks::value(into = "new", eq = "manual", serialization = "none")]
...
impl ImportAttributes {
    ...
    fn as_reference_import_attributes(&self) -> titanpack_core::reference_type::ImportAttributes {
        match self {
            ImportAttributes::LightningCss {
                layer_name,
                supports,
                media,
            } => titanpack_core::reference_type::ImportAttributes {
                layer: layer_name
                    .as_ref()
