(globalThis.TITANPACK = globalThis.TITANPACK || []).push([
    "output/79fb1_titanpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_40d141.js",
    {},
    {"otherChunks":["output/79fb1_titanpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_7e4b32.js"],"runtimeModuleIds":["[project]/crates/titanpack-tests/tests/snapshot/runtime/default_dev_runtime/input/index.js [test] (ecmascript)"]}
]);
(() => {
if (!Array.isArray(globalThis.TITANPACK)) {
    return;
}

const CHUNK_BASE_PATH = "";
const RUNTIME_PUBLIC_PATH = "";
const OUTPUT_ROOT = "crates/titanpack-tests/tests/snapshot/runtime/default_dev_runtime";
/**
 * This file contains runtime types and functions that are shared between all
 * TitanPack ECMAScript runtimes.
 *
...
const titanpackQueues = Symbol("titanpack queues");
const titanpackExports = Symbol("titanpack exports");
const titanpackError = Symbol("titanpack error");
    ...
    return deps.map((dep)=>{
        if (dep !== null && typeof dep === "object") {
            ...
            if (isPromise(dep)) {
                ...
                const obj = {
                    [titanpackExports]: {},
                    [titanpackQueues]: (fn)=>fn(queue)
                };
                dep.then((res)=>{
                    obj[titanpackExports] = res;
                    resolveQueue(queue);
                }, (err)=>{
                    obj[titanpackError] = err;
                    resolveQueue(queue);
                });
                return obj;
            }
...
function asyncModule(module, body, hasAwait) {
    ...
    function handleAsyncDependencies(deps) {
        ...
        const getResult = ()=>currentDeps.map((d)=>{
                if (d[titanpackError]) throw d[titanpackError];
                return d[titanpackExports];
            });
        ...
        currentDeps.map((dep)=>dep[titanpackQueues](fnQueue));
        return fn.queueCount ? promise : getResult();
    }
    function asyncResult(err) {
        if (err) {
            reject(promise[titanpackError] = err);
        } else {
            resolve(exports);
        }
        resolveQueue(queue);
...
/**
 * This file contains runtime types and functions that are shared between all
 * Titanpack *development* ECMAScript runtimes.
 *
...
function createModuleHot(moduleId, hotData) {
    ...
    const hot = {
        ...
        // want the webpack code paths to ever update (the titanpack paths handle
        // this already).
...
globalThis.TITANPACK_CHUNK_UPDATE_LISTENERS ??= [];
const chunkListsToRegister = globalThis.TITANPACK_CHUNK_LISTS;
if (Array.isArray(chunkListsToRegister)) {
    for (const chunkList of chunkListsToRegister){
        registerChunkList(globalThis.TITANPACK_CHUNK_UPDATE_LISTENERS, chunkList);
    }
}
...
/**
 * This file contains the runtime code specific to the Titanpack development
...
const chunksToRegister = globalThis.TITANPACK;
globalThis.TITANPACK = { push: registerChunk };
chunksToRegister.forEach(registerChunk);
})();


//# sourceMappingURL=79fb1_titanpack-tests_tests_snapshot_runtime_default_dev_runtime_input_index_40d141.js.map