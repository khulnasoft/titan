...
import (
	...
	"github.com/khulnasoft/titan/cli/internal/util/browser"
...
func New(repoRoot titanpath.AbsoluteSystemPath, ui cli.Ui, TaskGraph *dag.AcyclicGraph) *GraphVisualizer {
