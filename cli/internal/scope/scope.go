...
import (
	...
	scope_filter "github.com/khulnasoft/titan/cli/internal/scope/filter"
	...
	"github.com/khulnasoft/titan/cli/internal/util/filter"
...
func addLegacyFlagsFromArgs(opts *LegacyFilter, args *titanstate.ParsedArgsFromRust) {
...
// Opts holds the options for how to select the entrypoint packages for a titan run
type Opts struct {
	...
	PackageInferenceRoot titanpath.RelativeSystemPath
}
...
in the root directory. Includes titan.json, root package.json, and the root lockfile by default.`
)
...
func resolvePackageInferencePath(raw string) (titanpath.RelativeSystemPath, error) {
	pkgInferenceRoot, err := titanpath.CheckedToRelativeSystemPath(raw)
	if err != nil {
...
func OptsFromArgs(opts *Opts, args *titanstate.ParsedArgsFromRust) error {
...
func ResolvePackages(opts *Opts, repoRoot titanpath.AbsoluteSystemPath, scm scm.SCM, ctx *context.Context, tui cli.Ui, logger hclog.Logger) (util.Set, bool, error) {
...
func calculateInference(repoRoot titanpath.AbsoluteSystemPath, pkgInferencePath titanpath.RelativeSystemPath, packageInfos workspace.Catalog, logger hclog.Logger) (*scope_filter.PackageInference, error) {
	if pkgInferencePath == "" {
...
func (o *Opts) getPackageChangeFunc(scm scm.SCM, repoRoot titanpath.AbsoluteSystemPath, ctx *context.Context, logger hclog.Logger) scope_filter.PackagesChangedInRange {
...
func getChangesFromLockfile(repoRoot titanpath.AbsoluteSystemPath, scm scm.SCM, ctx *context.Context, changedFiles []string, fromRef string) ([]string, bool) {
...
func getDefaultGlobalDeps() []string {
	// include titan.json and root package.json as implicit global dependencies
