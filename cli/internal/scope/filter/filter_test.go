...
func Test_filter(t *testing.T) {
	...
	packageJSONs["project-0"] = &fs.PackageJSON{
		Name: "project-0",
		Dir:  titanpath.AnchoredUnixPath("packages/project-0").ToSystemPath(),
	}
	graph.Add("project-1")
	packageJSONs["project-1"] = &fs.PackageJSON{
		Name: "project-1",
		Dir:  titanpath.AnchoredUnixPath("packages/project-1").ToSystemPath(),
	}
	graph.Add("project-2")
	...
	packageJSONs["project-6"] = &fs.PackageJSON{
		Name: "project-6",
		Dir:  titanpath.AnchoredUnixPath("project-5/packages/project-6").ToSystemPath(),
	}
	// Add dependencies
	...
	testCases := []struct {
		...
		// },
		{
			...
			[]*TargetSelector{
				{
					parentDir: titanpath.MakeRelativeSystemPath("packages", "*"),
				},
			},
			nil,
			[]string{"project-0", "project-1"},
		},
		{
			...
			[]*TargetSelector{{parentDir: titanpath.MakeRelativeSystemPath("..", "packages", "*")}},
			&PackageInference{
				DirectoryRoot: titanpath.MakeRelativeSystemPath("project-5"),
			},
			[]string{"project-0", "project-1"},
		},
		{
			...
			[]*TargetSelector{
				{
					parentDir: titanpath.MakeRelativeSystemPath("project-5", "**"),
				},
			},
			nil,
		...
		},
		{
			...
			[]*TargetSelector{
				{
					parentDir: titanpath.MakeRelativeSystemPath("."), // input . gets cleaned to ""
				},
			},
			nil,
			[]string{util.RootPkgName},
		},
		{
			...
			[]*TargetSelector{},
			&PackageInference{
				DirectoryRoot: titanpath.MakeRelativeSystemPath("packages"),
			},
			[]string{"project-0", "project-1"},
		},
		{
			...
			[]*TargetSelector{},
			&PackageInference{
				DirectoryRoot: titanpath.MakeRelativeSystemPath("packages", "project-0"),
		...
		},
		{
			...
			[]*TargetSelector{},
			&PackageInference{
				DirectoryRoot: titanpath.MakeRelativeSystemPath("packages", "project-0", "src"),
				PackageName:   "project-0",
			},
			[]string{"project-0"},
		},
...
func Test_matchScopedPackage(t *testing.T) {
	...
	packageJSONs["@foo/bar"] = &fs.PackageJSON{
		Name: "@foo/bar",
		Dir:  titanpath.AnchoredUnixPath("packages/bar").ToSystemPath(),
	}
	r := &Resolver{
		Graph:          graph,
		WorkspaceInfos: workspaceInfos,
...
func Test_matchExactPackages(t *testing.T) {
	...
	packageJSONs["@foo/bar"] = &fs.PackageJSON{
		Name: "@foo/bar",
		Dir:  titanpath.AnchoredUnixPath("packages/@foo/bar").ToSystemPath(),
	}
	graph.Add("bar")
...
func Test_matchMultipleScopedPackages(t *testing.T) {
	...
	packageJSONs["@types/bar"] = &fs.PackageJSON{
		Name: "@types/bar",
		Dir:  titanpath.AnchoredUnixPath("packages/@types/bar").ToSystemPath(),
	}
	r := &Resolver{
		Graph:          graph,
		WorkspaceInfos: workspaceInfos,
...
func Test_SCM(t *testing.T) {
	...
	testCases := []struct {
		...
		//
		// titan-specific tests below here
		{
