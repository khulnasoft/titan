...
const (
	// Infer - infer environment variable constraints from titan.json
	Infer EnvMode = "Infer"
...
// RunOpts holds the options that control the execution of a titan run
type RunOpts struct {
	...
	// Whether titan should create a run summary
	Summarize bool
