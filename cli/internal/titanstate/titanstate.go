// Package titanstate holds all of the state given from the Rust CLI
// that is necessary to execute titan. We transfer this state from Rust
...
// ExecutionState is the entire state of a titan execution that is passed from the Rust shim.
