...
func newGitSCM(repoRoot titanpath.AbsoluteSystemPath) SCM {
...
func newFallback(repoRoot titanpath.AbsoluteSystemPath) (SCM, error) {
...
func GetCurrentBranch(dir titanpath.AbsoluteSystemPath) string {
...
func GetCurrentSha(dir titanpath.AbsoluteSystemPath) string {
