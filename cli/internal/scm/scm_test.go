...
func TestGetCurrentBranchMain(t *testing.T) {
	...
	// Setup git
	gitCommand(t, testDir, []string{"config", "--global", "user.email", "titan@vercel.com"})
	gitCommand(t, testDir, []string{"config", "--global", "user.name", "Titanbot"})
...
func gitRm(t *testing.T, dir titanpath.AbsoluteSystemPath) {
...
func getOriginalConfig(cwd titanpath.AbsoluteSystemPath) (string, string) {
...
func gitCommand(t *testing.T, cwd titanpath.AbsoluteSystemPath, args []string) string {
...
func _gitCommand(cwd titanpath.AbsoluteSystemPath, args []string) (string, error) {
