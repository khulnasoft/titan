...
type testCache struct {
	...
	entries     map[string][]titanpath.AnchoredSystemPath
}

func (tc *testCache) Fetch(_ titanpath.AbsoluteSystemPath, hash string, _ []string) (ItemStatus, []titanpath.AnchoredSystemPath, error) {
...
func (tc *testCache) Put(_ titanpath.AbsoluteSystemPath, hash string, _ int, files []titanpath.AnchoredSystemPath) error {
	if tc.disabledErr != nil {
...
func (tc *testCache) Clean(_ titanpath.AbsoluteSystemPath) {}
func (tc *testCache) CleanAll()                            {}
func (tc *testCache) Shutdown()                            {}

func newEnabledCache() *testCache {
	return &testCache{
		entries: make(map[string][]titanpath.AnchoredSystemPath),
	}
}
...
func TestPutCachingDisabled(t *testing.T) {
	...
	err := mplex.Put("unused-target", "some-hash", 5, []titanpath.AnchoredSystemPath{"a-file"})
	if err != nil {
