...
type cacheRequest struct {
	anchor   titanpath.AbsoluteSystemPath
	key      string
	duration int
...
func (c *asyncCache) Put(anchor titanpath.AbsoluteSystemPath, key string, duration int, files []titanpath.AnchoredSystemPath) error {
...
func (c *asyncCache) Fetch(anchor titanpath.AbsoluteSystemPath, key string, files []string) (ItemStatus, []titanpath.AnchoredSystemPath, error) {
...
func (c *asyncCache) Clean(anchor titanpath.AbsoluteSystemPath) {
