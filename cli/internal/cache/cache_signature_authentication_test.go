...
import (
	...
	"github.com/khulnasoft/titan/cli/internal/edgecases"
...
func Test_SecretKeySuccess(t *testing.T) {
	teamID := "team_someid"
	secretKeyEnvName := "TITAN_REMOTE_CACHE_SIGNATURE_KEY"
...
func Test_SecretKeyErrors(t *testing.T) {
	...
	// Env secret key TITAN_REMOTE_CACHE_SIGNATURE_KEY is not set
