...
type PackageManager struct {
	...
	// Gets lockfile name.
	GetLockfileName func(projectDirectory titanpath.AbsoluteSystemPath) string
...
func (pm PackageManager) GetWorkspaces(rootpath titanpath.AbsoluteSystemPath) ([]string, error) {
...
func (pm PackageManager) GetWorkspaceIgnores(rootpath titanpath.AbsoluteSystemPath) ([]string, error) {
	return pm.getWorkspaceIgnores(pm, rootpath)
}

// ReadLockfile will read the applicable lockfile into memory
func (pm PackageManager) ReadLockfile(projectDirectory titanpath.AbsoluteSystemPath, rootPackageJSON *fs.PackageJSON) (lockfile.Lockfile, error) {
