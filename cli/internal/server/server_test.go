...
import (
	...
	titanfs "github.com/khulnasoft/titan/cli/internal/fs"
...
func TestDeleteRepoRoot(t *testing.T) {
	...
	repoRoot := titanfs.AbsoluteSystemPathFromUpstream(repoRootRaw)
...
func TestShutdown(t *testing.T) {
	...
	_, err = s.Shutdown(ctx, &titandprotocol.ShutdownRequest{})
