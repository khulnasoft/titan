...
// and in titanrepo-ffi/lib.rs before modifying this file.

// #include "bindings.h"
//
// #cgo darwin,arm64 LDFLAGS:  -L${SRCDIR} -ltitanrepo_ffi_darwin_arm64  -lz -liconv -framework Security -framework CoreFoundation
// #cgo darwin,amd64 LDFLAGS:  -L${SRCDIR} -ltitanrepo_ffi_darwin_amd64  -lz -liconv -framework Security -framework CoreFoundation
// #cgo linux,arm64,staticbinary LDFLAGS:   -L${SRCDIR} -ltitanrepo_ffi_linux_arm64 -lunwind -lm
// #cgo linux,amd64,staticbinary LDFLAGS:   -L${SRCDIR} -ltitanrepo_ffi_linux_amd64 -lunwind -lm
// #cgo linux,arm64,!staticbinary LDFLAGS:   -L${SRCDIR} -ltitanrepo_ffi_linux_arm64 -lz -lm
// #cgo linux,amd64,!staticbinary LDFLAGS:   -L${SRCDIR} -ltitanrepo_ffi_linux_amd64 -lz -lm
// #cgo windows,amd64 LDFLAGS: -L${SRCDIR} -ltitanrepo_ffi_windows_amd64 -lole32 -lbcrypt -lws2_32 -luserenv -lntdll
import "C"
...
import (
	...
	ffi_proto "github.com/khulnasoft/titan/cli/internal/ffi/proto"
...
// GetTitanDataDir returns the path to the Titan data directory
func GetTitanDataDir() string {
	buffer := C.get_titan_data_dir()
	resp := ffi_proto.TitanDataDirResp{}
...
func ChangedFiles(gitRoot string, titanRoot string, fromCommit string, toCommit string) ([]string, error) {
