...
import (
	...
	"github.com/khulnasoft/titan/cli/internal/filewatcher"
...
func New(logger hclog.Logger, repoRoot titanpath.AbsoluteSystemPath, cookieWaiter filewatcher.CookieWaiter) *GlobWatcher {
	return &GlobWatcher{
		logger:       logger,
		repoRoot:     repoRoot,
