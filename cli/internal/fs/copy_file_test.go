...
func TestCopyFile(t *testing.T) {
	srcTmpDir := titanpath.AbsoluteSystemPath(t.TempDir())
	destTmpDir := titanpath.AbsoluteSystemPath(t.TempDir())
	...
	symlinkSrcDir := titanpath.AbsoluteSystemPath(t.TempDir())
	symlinkTargetDir := titanpath.AbsoluteSystemPath(t.TempDir())
	symlinkDestDir := titanpath.AbsoluteSystemPath(t.TempDir())
...
func TestCopyOrLinkFileWithPerms(t *testing.T) {
	...
	srcDir := titanpath.AbsoluteSystemPath(t.TempDir())
	dstDir := titanpath.AbsoluteSystemPath(t.TempDir())
