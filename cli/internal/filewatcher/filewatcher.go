...
type Backend interface {
	AddRoot(root titanpath.AbsoluteSystemPath, excludePatterns ...string) error
	Events() <-chan Event
	Errors() <-chan error
	Close() error
	Start() error
...
func New(logger hclog.Logger, repoRoot titanpath.AbsoluteSystemPath, backend Backend) *FileWatcher {
...
// events.
func (fw *FileWatcher) AddRoot(root titanpath.AbsoluteSystemPath, excludePatterns ...string) error {
