...
codemodCli
  .name("@titan/codemod")
  .description(
    "Codemod transformations to help upgrade your Titanrepo codebase when a feature is deprecated."
  )
...
codemodCli
  ...
  .description("Migrate a project to the latest version of Titanrepo")
  ...
  .option("--install", "Install new version of titan after migration", true)
  .option(
    "--force",
