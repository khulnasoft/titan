...
Titanrepo provides Codemod transformations to help upgrade your Titanrepo codebase.
...
Updates your Titanrepo codebase to the specified version of Titanrepo (defaults to the latest), running any required codemods, and installing the new version of Titanrepo.

```
Usage: @titan/codemod migrate|update [options] [path]

Migrate a project to the latest version of Titanrepo
...
Options:
  ...
  --install         Install new version of titan after migration (default: true)
...
```
Usage: @titan/codemod transform [options] [transform] [path]
       @titan/codemod [options] [transform] [path]
