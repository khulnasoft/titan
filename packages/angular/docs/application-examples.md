...
```bash
nx g @titan/angular:application my-app
```
...
```bash
nx g @titan/angular:app my-app --directory=my-dir/my-app --style=scss
```
...
```bash
nx g @titan/angular:app my-app --inlineStyle --inlineTemplate
```
...
```bash
nx g @titan/angular:app my-app --prefix=admin --tags=scope:admin,type:ui
```
