...
```shell
nx g @titan/angular:cypress-component-configuration --project=my-cool-angular-project
```
...
For Angular projects, the build target needs to be using the `@titan/angular:webpack-browser` or
...
```shell
nx g @titan/angular:cypress-component-configuration --project=my-cool-angular-project --build-target:some-angular-app:build --generate-tests
```
...
```shell
nx g @titan/angular:cypress-component-configuration --project=my-cool-angular-project --generate-tests
```
