...
const titanGenCli = new Command();

titanGenCli
  .name(chalk.bold(logger.titanGradient("@titan/gen")))
  .description("Extend your Titanrepo")
...
titanGenCli
  ...
  .addOption(
    new Option(
      "-c, --config <config>",
      "Generator configuration file (default: titan/generators/config.js"
    )
  )
  .addOption(
    new Option(
