...
describe("examples", () => {
  describe("isUrlOk", () => {
    it("returns true if url returns 200", async () => {
      ...
      const url = "https://github.com/khulnasoft/titan/";
    ...
    it("returns false if url returns status != 200", async () => {
      ...
      const url = "https://not-github.com/khulnasoft/titan/";
      const result = await isUrlOk(url);
  ...
  describe("getRepoInfo", () => {
    test.each([
      {
        repoUrl: "https://github.com/khulnasoft/titan/",
      ...
      {
        repoUrl:
          "https://github.com/khulnasoft/titan/tree/canary/examples/kitchen-sink",
        examplePath: undefined,
      ...
      {
        repoUrl: "https://github.com/khulnasoft/titan/tree/tek/test-branch/",
    ...
    test.each([
      {
        ...
        expected: true,
        expectedUrl:
          "https://api.github.com/repos/khulnasoft/titan/contents/package.json?ref=main",
      },
    ])(
