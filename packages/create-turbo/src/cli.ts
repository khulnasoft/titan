...
const createTitanCli = new Command();

// create
createTitanCli
  .name(chalk.bold(logger.titanGradient("create-titan")))
  .description("Create a new Titanrepo")
  ...
  .option(
    "--titan-version <version>",
    "Use a specific version of titan (default: latest)"
  )
  .option(
    "-e, --example [name]|[github-url]",
    `
  An example to bootstrap the app with. You can use an example name
  from the official Titanrepo repo or a GitHub URL. The URL can use
