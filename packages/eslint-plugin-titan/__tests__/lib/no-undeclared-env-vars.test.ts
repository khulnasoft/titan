  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "ENV_3 is not listed as a dependency in the root titan.json or workspace (apps/web) titan.json",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      errors: [
        {
          message:
            "ENV_2 is not listed as a dependency in the root titan.json or workspace (apps/docs) titan.json",
        },
      ],
    },
    {
      ...
      errors: [
        {
          message:
            "NEXT_PUBLIC_EXCLUDE is not listed as a dependency in the root titan.json or workspace (apps/web) titan.json",
        },
        {
          message:
            "NEXT_PUBLIC_EXCLUDED is not listed as a dependency in the root titan.json or workspace (apps/web) titan.json",
        },
      ],
    },
    {
