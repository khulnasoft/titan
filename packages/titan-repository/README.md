...
This package builds `@titan/repository`, which in turn packages up some of Titanrepo's repository analysis functionality
for use in a javascript context.

The `rust/` folder contains the wrapper around core Titanrepo Rust code, and should limit
itself to basic data transformations to match JS APIs. Any logic updates should preferably land in core Titanrepo.
