...
// TODO: find-up to titan-repository? This currently only works from titan-repository/js/dist
const localPath = join(__dirname, "..", "..", "native", "@titan");
const pkgRoot = "@titan/repository";
