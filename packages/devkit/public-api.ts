/**
 * Note to developers: STOP! This is the Public API of @titan/devkit.
 * @titan/devkit should be compatible with versions of Nx 1 major version prior.
 * This is so that plugins can use the latest @titan/devkit while their users may use versions +/- 1 of Nx.
 *
